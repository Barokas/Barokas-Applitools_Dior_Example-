...
export default defineConfig<EyesFixture>({
  timeout: 60000,
  use: {
    // Timeout for each individual action (e.g., click, fill, goto)
    actionTimeout: 30000,
    navigationTimeout: 60000, // You can also set a specific timeout for navigation here
  },
  testDir: './tests',
  ...
  use: {
    ...
    eyesConfig: {
      ...
      { name: 'edgechromium', width: 1024, height: 768 },
      {
        chromeEmulationInfo: {
          deviceName: 'Pixel 5',
